...
public class XiaoshouyuangongEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public XiaoshouyuangongEntity() {

	}

	public XiaoshouyuangongEntity(T t) {
		try {
    ...
    public String toString() {
        return "Xiaoshouyuangong{" +
            ...
            ", username=" + username +
            ", password=" + password +
            ", xiaoshouyuangongUuidNumber=" + xiaoshouyuangongUuidNumber +
            ", xiaoshouyuangongName=" + xiaoshouyuangongName +
            ", xiaoshouyuangongPhone=" + xiaoshouyuangongPhone +
            ", xiaoshouyuangongIdNumber=" + xiaoshouyuangongIdNumber +
            ", xiaoshouyuangongPhoto=" + xiaoshouyuangongPhoto +
            ", sexTypes=" + sexTypes +
            ", xiaoshouyuangongEmail=" + xiaoshouyuangongEmail +
