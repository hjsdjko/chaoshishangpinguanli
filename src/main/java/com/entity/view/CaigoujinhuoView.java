...
public class CaigoujinhuoView extends CaigoujinhuoEntity implements Serializable {
	...
	public CaigoujinhuoView() {

	}

	public CaigoujinhuoView(CaigoujinhuoEntity caigoujinhuoEntity) {
		try {
			BeanUtils.copyProperties(this, caigoujinhuoEntity);
